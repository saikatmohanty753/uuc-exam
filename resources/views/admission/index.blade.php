                                ...
                                <div class="col-md-3 col-12">
                                    <div class="mb-2">
                                        <div class="form-group input-cont">
                                            ...
                                            <input name="aadhar_no" type="text" class="form-control chk_blank chk_aadhaar"
                                                id="aadhar">
                                            <span class="error-msg"></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-3">
                                            <div class="mb-2">
                                                ...
                                                <label class="form-label" for="blog-edit-status">State <span
                                                        class="text-danger">*</span></label>
                                                <select class="custom-select form-control chk_blank" name="permanent_state"
                                                    id="permanent_state">
                                                    <option value="ODISHA">Odisha</option>
                                                </select>
                                                <span class="error-msg"></span>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 col-12">
                                    <div class="mb-2">
                                        ...
                                        <label class="form-label">Year of Passing Last Exam <span
                                                class="text-danger">*</span></label>
                                        <input name="last_passing_year" type="text" class="form-control chk_blank yearPicker"
                                ...
                                <div class="col-md-3 col-12">
                                    <div class="mb-2">
                                        ...
                                        <select class="custom-select form-control chk_blank" id="is_migration" name="is_migration">
                                            <option value="0">No</option>
                                            <option value="1">Yes</option>
                                        </select>
                                        <span class="error-msg"></span>
                            ...
                            <div class="row mb-2">
                                <div class="col-md-3 col-12">
                                    <div class="form-group">
                                        ...
                                        <div class="custom-file  input-cont">
                                            <input type="file" class="custom-file-input form-control chk_blank chk_pdf_file chk_doc_size" name="profile"
                                                id="photo">
                                ...
                                <div class="col-md-3 col-12">
                                    <div class="form-group">
                                        ...
                                        <div class="custom-file input-cont">
                                            <input type="file" class="custom-file-input form-control chk_blank chk_pdf_file chk_doc_size" name="aadhaar_card"
                                                id="aadhaar_card">
                                                <small class="form-text text-secondary">{{ __('common.file_format') }}</small>
                                            <label class="custom-file-label">Choose
                                                file...</label>
                                ...
                                <div class="col-md-3 col-12">
                                    <div class="form-group">
                                        <label class="form-label">HSC Certificate <span
                                                class="text-danger">*</span></label>
                                        <div class="custom-file input-cont">
                                            <input type="file" class="custom-file-input form-control chk_blank chk_pdf_file chk_doc_size" name="hsc_cert"
                                                id="hsc_cert">
                                                <small class="form-text text-secondary">{{ __('common.file_format') }}</small>
                                            <label class="custom-file-label">Choose
                                                file...</label>
                                ...
                                <div class="col-md-3 col-12">
                                    <div class="form-group">
                                        ...
                                        <div class="custom-file input-cont">
                                            <input type="file" class="custom-file-input form-control chk_pdf_file chk_doc_size" name="migration_cert"
                                                id="migration_cert">
                                                <small class="form-text text-secondary">{{ __('common.file_format') }}</small>
                                            <label class="custom-file-label">Choose
                                                file...</label>
