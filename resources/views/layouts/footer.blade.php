...
<footer class="page-footer" role="contentinfo">
    <div class="d-flex align-items-center flex-1 text-muted">
        <span class="hidden-md-down fw-700">2022 - 23 © UUC-STUDENT-PORTAL by&nbsp;<a href='https://oasystspl.com/'
                class='text-primary fw-500' title='OASYS TECH SOLUTIONS PVT. LTD.' target='_blank'></a>OASYS TECH
            SOLUTIONS PVT.
            LTD.</span>
    </div>
    <div>
...
<div class="modal fade" id="view_reason" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">
                    <small class="m-0 text-muted" id="remark_div">
