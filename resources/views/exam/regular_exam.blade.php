                                    ...
                                    <div class="mb-2">
                                        <div class="form-group input-cont">
                                            ...
                                            <input name="name" type="text" class="form-control chk_blank"
                                                    id="student_name" placeholder="Enter Full Name" value="{{$student_details->name}}">
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="mb-2">
                                        <div class="form-group input-cont">
                                            ...
                                            <input name="mobile" type="text"
                                                class="form-control chk_blank  chk_mobile" id="mobile" value="{{$student_details->mobile}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-12">
                                ...
                                <div class="col-md-3 col-12">
                                    <div class="mb-2">
                                        <div class="form-group input-cont">
                                            ...
                                            <input name="dob" type="text" id="dob"
                                                class="form-control  chk_blank chk_date" value="{{$edu_hsc->passing_year}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3 col-12">
                            ...
                            <div class="row">
                                    ...
                                    <div class="mb-2">
                                        <div class="form-group input-cont">
                                            ...
                                            <input name="dob" type="text" 
                                                class="form-control chk_blank chk_date" value="{{$edu_intermediate->passing_year}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3 col-12">
                                ...
                                <div class="col-md-4 col-12">
                                    <div class="mb-2">
                                        <div class="form-group input-cont">
                                            <label class="form-label">Roll No. <span class="text-danger">*</span></label>
                                            <input name="email" type="text" class="form-control chk_blank chk_email" id="email">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4 col-12">
                        ...
                        <div class="border rounded p-2 mb-4">
                            ...
                            <div class="row ">
                                <div class="col-md-6 col-12">
                                    <div class="mb-2">
                                        <div class="form-group input-cont">
                                            <label class="form-label">Year Of Admission<span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="mb-2">
                                        <div class="form-group input-cont">
                                            <label class="form-label">Month Of Admission <span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-4 col-12">
                                    <div class="mb-2">
                                        <div class="form-group input-cont">
                                            ...
                                            <input type="text" class="form-control" value="{{$fee[0]->amount}}" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4 col-12">
                                    <div class="mb-2">
                                        <div class="form-group input-cont">
                                            ...
                                            <input type="text" class="form-control" value="{{$fee[1]->amount}}" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4 col-12">
                                    <div class="mb-2">
                                        <div class="form-group input-cont">
                                            ...
                                            <input type="text" class="form-control" value="{{$fee[2]->amount}}" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4 col-12">
                                ...
                                <div class="col-md-4 col-12">
                                    <div class="mb-2">
                                        <div class="form-group input-cont">
                                            ...
                                            <input type="text" class="form-control" value="{{$fee[3]->amount}}" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4 col-12">
