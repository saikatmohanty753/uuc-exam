            ...
            <aside class="page-sidebar">
                <div class="page-logo">
                    <a href="#"
                        ...
                        <img src="{{ asset('backend/img/logo.png') }}" alt=" Utkal University of Culture"
                ...
                <nav id="js-primary-nav" class="primary-nav" role="navigation">
                    ...
                    <div class="info-card">
                        ...
                        <img src="{{ asset('backend/img/card-backgrounds/cover-2-lg.png') }}" class="cover"
                            alt="cover">
                    ...
                    <ul id="js-nav-menu" class="nav-menu">
                        <li class="active open">
                            <a href="#" title="Dash Board" data-filter-tags="Dash Board">
                                <i class="fal fa-home"></i>
                                <span class="nav-link-text" data-i18n="nav.application_intel">Dash Board</span>
                            </a>
                        </li>
                        <li>
            ...
            <div class="page-content-wrapper">
                ...
                <header class="page-header" role="banner">
                    ...
                    <div class="page-logo">
                        <a href="#"
                            class="page-logo-link press-scale-down d-flex align-items-center position-relative"
                            data-toggle="modal" data-target="#modal-shortcut">
                            <img src="{{ asset('backend/img/favicon/favicon.png') }}"
                                alt=" Utkal University of Culture" aria-roledescription="logo">
                            <span class="page-logo-text mr-1"> Utkal University of Culture</span>
                            <span
                                ...
                                <div class="dropdown-header bg-trans-gradient d-flex flex-row py-4 rounded-top">
                                    <div class="d-flex flex-row align-items-center mt-1 mb-1 color-white">
                                        ...
                                        <div class="info-card-text">
                                            ...
                                            <span
                                                class="text-truncate text-truncate-md opacity-80">admin@admin.com</span>
                                        </div>
                                    </div>
                                </div>
                ...
                <footer class="page-footer" role="contentinfo">
                    <div class="d-flex align-items-center flex-1 text-muted">
                        <span class="hidden-md-down fw-700">2023 © UUC-STUDENT-PORTAL by&nbsp;<a
                                href='https://oasystspl.com/' class='text-primary fw-500'
                                title='OASYS TECH SOLUTIONS PVT. LTD.' target='_blank'></a>OASYS TECH SOLUTIONS PVT.
                            LTD.</span>
                    </div>
                    <div>
                ...
                <div class="modal-body p-0">
                    <div class="settings-panel">
                        ...
                        <div class="list mt-1">
                            ...
                            <span class="onoffswitch-title-desc d-block mb-g">Change <strong>root</strong> font size
                                to effect rem values</span>
                        </div>
                        <div class="mt-2 d-table w-100 pl-5 pr-3">
                            <div class="d-table-cell align-middle">
                                ...
                                <div class="fs-xs text-muted p-2 alert alert-warning mt-3 mb-0">
                                    <i class="fal fa-exclamation-triangle text-warning mr-2"></i>Due to network
                                    latency and CPU utilization, you may experience a brief flickering effect on page
                                    load which may show the intial applied theme for a split second. Setting the
                                    prefered style/theme in the header will prevent this from happening.
                                </div>
                            </div>
                        </div>
